...
const translations = {
  en: {
    ...
    "patient.ratingLabel": "Hospital Rating",
    ...
    "patient.toastRatingHospitalMissing": "Hospital details are not available yet.",
    "patient.toastRatingFailed": "Failed to submit your rating. Please try again.",
  ...
  ar: {
    ...
    "lang.arabic": "العربية",
    "common.dismiss": "تمام",
    "common.lastUpdated": "آخر تحديث {time}",
    "common.live": "تحديثات مباشرة",
    "common.offline": "غير متصل",
    "common.justNow": "الآن",
    "common.minutesAgo": "منذ {count} دقيقة",
    "common.minutesLabel": "دقيقة",
    "common.refresh": "تحديث",
    "common.searching": "جاري البحث...",
    "common.loading": "جاري التحميل...",
    "common.unavailable": "غير متاح",
    "common.reserve": "احجز العناية",
    "common.reserveShort": "احجز",
    "common.cancel": "إلغاء",
    "common.submit": "إرسال",
    "common.optional": "اختياري",
    "common.yes": "نعم",
    "common.no": "لا",
    "patient.welcome": "أهلاً {name}",
    "patient.pendingReservation":
      "حجز العناية في الانتظار. جاري انتظار تأكيد الاستقبال...",
    "patient.noReservation": "لا يوجد حجز عناية حتى الآن. اختر من القائمة بالأسفل.",
    "patient.reservedIcu": "العناية المحجوزة",
    "patient.cancelReservation": "إلغاء حجز العناية",
    "patient.cancelling": "جاري الإلغاء...",
    "patient.trackAmbulance": "تتبع الإسعاف / إدارة الطلب",
    "patient.ambulanceRequested": "تم طلب الإسعاف",
    "patient.ambulanceEnRoute": "الإسعاف في الطريق",
    "patient.arrived": "تم الوصول",
    "patient.bannerPending":
      "تم تعيين إسعاف لالتقاطك وسيتم القبول قريباً.",
    "patient.bannerTransit":
      "الإسعاف في الطريق لالتقاطك. الرجاء الاستعداد.",
    "patient.bannerArrived":
      "وصلت إلى المستشفى. سيتم إنهاء إجراءات الدخول قريباً.",
    "patient.pickupLocation": "موقع الالتقاط",
    "patient.yourIcu": "العناية المحجوزة",
    "patient.hospital": "المستشفى",
    "patient.specialization": "التخصص",
    "patient.status": "الحالة",
    "patient.dailyFee": "الرسوم اليومية",
    "patient.totalFees": "إجمالي الرسوم",
    "patient.feePaid": "تم الدفع",
    "patient.feeUnpaid": "لم يتم الدفع",
    "patient.feedback": "تقييم الخدمة",
    "patient.rateHospital": "قيّم المستشفى",
    "patient.rateTarget": "قيّم {target}",
    "patient.ratingPlaceholder": "اكتب تعليقاً (اختياري)...",
    "patient.ratingLabel": "تقييم المستشفى",
    "patient.gettingStarted": "ابدأ الآن",
    "patient.stepChoose": "اختر مستشفى به عناية متاحة.",
    "patient.stepReserve": "احجز عناية لتأكيد مكانك.",
    "patient.stepPickup": "اطلب إسعاف إذا كنت تحتاج التوصيل.",
    "patient.stepTrack": "تابع حالتك لحظة بلحظة.",
    "patient.toastUserIdMissing": "تعذر العثور على المستخدم. يرجى تسجيل الدخول مرة أخرى.",
    "patient.toastLoadFailed": "تعذر تحميل بيانات المريض. حاول مرة أخرى.",
    "patient.toastCheckedIn": "تم تسجيل دخولك في {hospitalName} - غرفة {room}!",
    "patient.toastAmbulanceOnWay": "{message} الإسعاف في الطريق إلى {hospitalName}!",
    "patient.toastPickupSent": "تم إرسال طلب الإسعاف إلى الطاقم.",
    "patient.toastCheckedOut": "تم إنهاء إقامتك. شكراً لاختيارك خدماتنا.",
    "patient.toastReservationCancelled": "تم إلغاء حجز العناية.",
    "patient.toastAmbulanceAccepted": "الإسعاف في الطريق لالتقاطك.",
    "patient.toastArrived": "وصلت إلى المستشفى. يرجى التوجه للاستقبال.",
    "patient.toastNoReservation": "لا يوجد حجز عناية لإلغائه.",
    "patient.toastCancelConfirm": "هل أنت متأكد من إلغاء حجز العناية؟",
    "patient.toastCancelSuccess": "تم إلغاء الحجز بنجاح!",
    "patient.toastCancelFailed": "فشل إلغاء الحجز. حاول مرة أخرى.",
    "patient.toastRatingRequired": "يرجى اختيار تقييم من 1 إلى 5.",
    "patient.toastRatingThanks": "شكراً لتقييمك لـ {target}!",
    "patient.toastRatingHospitalMissing": "تفاصيل المستشفى غير متاحة حالياً.",
    "patient.toastRatingFailed": "تعذر إرسال التقييم. حاول مرة أخرى.",
    "patient.loadFailed": "تعذر تحميل بيانات المريض.",
    "icu.selectTitle": "اختيار أقرب عناية متاحة",
    "icu.selectSubtitle": "تحديثات فورية. اضغط حجز لتأكيد العناية.",
    "icu.searchPlaceholder": "ابحث باسم المستشفى",
    "icu.allSpecializations": "كل التخصصات",
    "icu.specialization.surgical": "عناية جراحية",
    "icu.specialization.cardiac": "عناية قلبية",
    "icu.specialization.neonatal": "عناية حديثي الولادة",
    "icu.specialization.pediatric": "عناية أطفال",
    "icu.specialization.neurological": "عناية عصبية",
    "icu.refresh": "تحديث",
    "icu.availableIcus": "عنايات متاحة",
    "icu.hospitalsAvailable": "مستشفيات بها عناية متاحة",
    "icu.availableCount": "العنايات المتاحة: {count}",
    "icu.specializations": "التخصصات",
    "icu.noIcus": "لا توجد عنايات متاحة حالياً.",
    "icu.distanceUnavailable": "العنوان غير متاح",
    "icu.unknownHospital": "مستشفى غير معروف",
    "icu.finderTitle": "البحث عن عناية",
    "icu.insightsTitle": "معلومات سريعة",
    "icu.insightHospitals": "{count} مستشفى متاح",
    "icu.insightIcus": "{count} عناية متاحة الآن",
    "icu.insightTopSpecialization": "أكثر تخصص متاح: {name} ({count})",
    "icu.insightAvgFee": "متوسط الرسوم: {value} ج.م/يوم",
    "icu.insightClosest": "أقرب مستشفى: {name} ({distance} كم)",
    "icu.liveLabel": "تحديثات مباشرة",
    "icu.justNow": "الآن",
    "icu.minutesAgo": "منذ {count} دقيقة",
    "icu.reservationTitle": "أكمل الحجز",
    "icu.pickupQuestion": "هل تحتاج إسعاف؟",
    "icu.pickupYes": "نعم، أحتاج إسعاف",
    "icu.pickupNo": "لا، سأصل بنفسي",
    "icu.pickupAddress": "عنوانك الحالي",
    "icu.pickupAddressPlaceholder": "اكتب عنوانك الحالي للاستقبال",
    "icu.confirmReservation": "تأكيد الحجز",
    "icu.reserving": "جاري الحجز...",
    "icu.toastReserved": "تم حجز عناية في {hospitalName}",
    "icu.toastAvailable": "أصبحت عناية جديدة متاحة.",
    "icu.toastStatusUpdate": "تم تحديث حالة العناية في {hospitalName}",
    "icu.toastLogin": "يرجى تسجيل الدخول لحجز عناية.",
    "icu.toastPickupRequired": "يرجى إدخال موقع الالتقاط",
    "icu.toastReservedRedirect": "تم الحجز. جاري تحويلك للوحة التحكم...",
    "icu.toastReservationFailed": "فشل الحجز. حاول مرة أخرى.",
    "map.loading": "جاري التحميل...",
    "map.myLocation": "📍 موقعي",
    "map.yourLocation": "📍 موقعك",
    "map.address": "العنوان",
    "map.contact": "التواصل",
    "map.distance": "المسافة",
    "map.specialization": "التخصص",
    "map.room": "الغرفة",
    "map.fee": "الرسوم",
    "map.ambulance": "إسعاف",
    "map.driver": "السائق",
    "map.status": "الحالة",
    "map.eta": "الوقت المتوقع",
    "map.destination": "الوجهة",
    "ambulance.title": "طلب إسعاف",
    "ambulance.subtitle": "حدد موقع الالتقاط واطلب إسعاف",
    "ambulance.activeRequest": "طلب إسعاف نشط",
    "ambulance.pickupLocation": "موقع الالتقاط",
    "ambulance.hospital": "المستشفى",
    "ambulance.urgency": "الأولوية",
    "ambulance.requested": "تم الطلب",
    "ambulance.enRoute": "الإسعاف في الطريق",
    "ambulance.crew": "الطاقم",
    "ambulance.eta": "الوقت المتوقع",
    "ambulance.distance": "المسافة",
    "ambulance.imAway": "أنا على بعد {distance} كم",
    "ambulance.etaRoute": "الوقت المتوقع (المسار)",
    "ambulance.cancelRequest": "إلغاء الطلب",
    "ambulance.liveMap": "موقع الإسعاف المباشر",
    "ambulance.pickupAddress": "عنوان الالتقاط ({optional})",
    "ambulance.pickupHint": "أو اضغط على الخريطة لتحديد موقع الالتقاط",
    "ambulance.urgencyLevel": "درجة الأولوية",
    "ambulance.requestPickup": "طلب إسعاف",
    "ambulance.selectPickupOnMap": "حدد موقع الالتقاط على الخريطة",
    "ambulance.clickMapHint": "اضغط على الخريطة لتحديد موقع الالتقاط",
    "ambulance.urgencyNormal": "عادية",
    "ambulance.urgencyUrgent": "عاجلة",
    "ambulance.urgencyCritical": "حرجة",
    "ambulance.notesLabel": "ملاحظات إضافية ({optional})",
    "ambulance.notesPlaceholder": "أي تعليمات خاصة أو حالات طبية...",
    "ambulance.toastArrivedAgain":
      "تم الوصول. يمكنك طلب إسعاف مرة أخرى إذا احتجت.",
    "ambulance.toastCancelled": "تم إلغاء طلب الإسعاف",
    "ambulance.toastLoadDetailsFailed": "تعذر تحميل بياناتك",
    "ambulance.toastPickupUpdated": "تم تحديث موقع الالتقاط إلى: {lat}، {lng}",
    "ambulance.toastSelectPickup": "يرجى تحديد موقع الالتقاط على الخريطة",
    "ambulance.toastNeedReservation": "يجب حجز عناية قبل طلب الإسعاف",
    "ambulance.toastRequestSent": "تم إرسال طلب الإسعاف. في انتظار القبول.",
    "ambulance.toastRequestFailed": "فشل إرسال طلب الإسعاف",
    "ambulance.toastCancelSuccess": "تم إلغاء طلب الإسعاف",
    "ambulance.toastCancelFailed": "فشل إلغاء الطلب",
    "ambulance.toastCancelConfirm": "هل تريد إلغاء طلب الإسعاف؟",
    "ambulance.sending": "جاري الإرسال...",
    "ambulance.selected": "المحدد: {lat}، {lng}",
  },
};
